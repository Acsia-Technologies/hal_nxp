...
static ADC_Type * const s_adcBase[ADC_INSTANCE_COUNT] = IP_ADC_BASE_PTRS;
                                ...
                                adc_converter_config_t * const config)
{
    ...
    if(instance == 0u)
    {
        const SIM_Type * const simBase = IP_SIM;
