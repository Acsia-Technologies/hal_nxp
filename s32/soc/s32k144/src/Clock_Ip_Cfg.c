...

    {
        ...
        /* SELECTOR initialization. */
        {
            ...
            #if CLOCK_IP_SELECTORS_NO > 23U
            {
                ...
                SIRCDIV2_CLK,       //SPLLDIV2_CLK             /* Name of the selected input source */
            },
            #endif
            ...
            #if CLOCK_IP_SELECTORS_NO > 25U
            {
                ...
                SOSCDIV2_CLK,//SPLLDIV2_CLK,                    /* Name of the selected input source */
            },
            #endif
        ...
        /* CLOCK GATES initialization. */
        {
            ...
            #if CLOCK_IP_GATES_NO > 31U      //CHECK Mischellaneous Sys control module
            {
                MSCM0_CLK,                    /* name */
                1U,                           /* enable */
            },
